		...
		<div className='gap-5 flex flex-col h-full p-10'>
			<div className='gap-5 flex flex-col h-full items-center'>
				...
				<div className='flex flex-col gap-3'>
					...
					<div>
						<p className='text-xl font-medium opacity-80'>Não foi possível encontrar a página do estabelecimento Verifique o QR Code e escaneie novamente</p>
					</div>
				</div>
			</div>
			...
			<div className='flex flex-row gap-1 opacity-70'>
				...
				<Link to={paths.auth.login.main} className='text-primary underline font-bold'>Faça login</Link>
			</div>
		</div>
	);
}
