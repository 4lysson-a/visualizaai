...
export default function CreateAccount({ setSteps }) {
  ...
  return (
    <div className='p-10 pt-5 flex w-full flex-col items-center h-full gap-5 overflow-auto'>
      ...
      <form
        className='bg-card p-4 flex flex-col w-full gap-2 rounded-xl'
          ...
          <div className='box-border flex flex-col gap-2'>
            <div>
              ...
              <p className='text-sm opacity-80'>
                {' '}
                <span className='text-primary'>Aviso:</span> Insira um email válido, você precisará confirma-lo mais tarde
              </p>
            </div>
            <input
              autoComplete='on'
        ...
        {loading.is ? (
          <button
            className={sty('shadow-xl rounded-xl p-3 text-primary bg-[var(--card)] border-2 h-15 border-primary font-bold flex flex-row gap-2 items-center justify-center', {
