...
export default function SubscriptionSubscribe() {
  ...
  return (
    <div className='h-full pt-10 pb-10 p-5 flex flex-col justify-around'>
      ...
      <h1 className='text-5xl font-bold text-primary text-center'>R$ 14,99 <span className='text-2xl opacity-80'>/mes</span></h1>
      {loading ? (
        ...
        <button onClick={handleClick} className='bg-primary text-background font-bold shadow-xl text-xl p-4 pl-10 pr-10 rounded-full active:scale-90'>
          Assinar
        </button>
      )}
    </div>
