    ...
    <div className='flex flex-col gap-5'>
      ...
      <div className='bg-card p-5 box-border flex flex-col gap-5 rounded-xl shadow-xl'>
        ...
        <div className='flex flex-col gap-5 xm:flex-row'>
          <button onClick={handleCopy} className='bg-[var(--primary)] p-2 xm:pl-5 xm:pr-5 rounded-full font-bold text-white gap-3 flex items-center justify-center active:scale-95 outline-none'>
            Copiar <CopySVG />
          </button>

          <button onClick={handleView} className='bg-blue-500 p-2 xm:pl-5 xm:pr-5 rounded-full font-bold text-white gap-3 flex items-center justify-center active:scale-95 outline-none'>
