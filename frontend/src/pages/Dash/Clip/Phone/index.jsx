  ...
  return (
    <div className="bg-card p-5 box-border flex flex-col gap-2 rounded-xl shadow-xl">
      ...
      <div className="w-full items-center flex justify-between">
        ...
        <button
          className="bg-texts p-2 rounded-full active:scale-90"
  ...
  return (
    <div className="flex flex-col gap-5 relative">
      ...
      <p className="flex flex-col gap-3">
        Este é o telefone no qual seus clientes poderão te enviar pedidos pelo
        carrinho de compra no aplicativo.
        <span className="text-primary text-sm">
          Desabilita-lo ou não inserir um número de telefone impedira seus
          clientes de usarem a funcionalidade de carrinho de compras.
        </span>
      </p>
