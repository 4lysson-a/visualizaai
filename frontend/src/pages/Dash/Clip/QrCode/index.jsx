    ...
    <div className='flex flex-col gap-6'>
      <div className='flex flex-col gap-3'>
        ...
        <p className='text-sm opacity-80'>
          <span className='text-primary'>Aviso:</span> O fundo apresentado na pré visualização abaixo, é apenas para demonstração, ao fazer o download do seu QR Code, ele virá com um fundo
          transparente
        </p>
      </div>
