...
export default function VariantOptions({
  ...
  return (
    <div className='flex gap-5 justify-center overflow-auto w-full bg-card p-4 rounded-xl'>
      <div
        className={sty('h-14 w-14 bg-white border-2 rounded-xl scale-100 active:scale-9', options.active === 'white' && 'border-primary shadow-xl scale-110')}
        onClick={() => handleOption('white')}
      />
      <div
        className={sty('h-14 w-14 bg-slate-900 rounded-xl border-2 scale-100 active:scale-90', options.active === 'night' && 'border-primary shadow-xl scale-110')}
