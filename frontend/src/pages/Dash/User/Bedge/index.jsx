...
function TrialBadge() {
  ...
  return (
    <div onClick={handleClick} className="bg-yellow-500 text-white font-bold rounded-md shadow-md px-2 py-1 fixed top-16 left-5">
      Período de teste
    </div>
  )
}
...
function InactiveBadge() {
  ...
  return (
    <div onClick={handleClick} className="bg-red-500 text-white font-bold rounded-md shadow-md px-2 py-1 fixed top-16 left-5">
      Assinatura inativa
    </div>
  )
}
