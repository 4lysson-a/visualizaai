    ...
    <div className='flex flex-col gap-2'>
      ...
      {!formData.category && (
        <p className='text-sm opacity-70 font-bold'>
          O produto não tem nenhuma categoria selecionada, <span className='text-red-500 border-b border-red-500'>Ele não sera exibido para o usuário final</span>. Apenas produtos categorizados são
